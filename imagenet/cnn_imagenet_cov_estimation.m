function [net, info] = cnn_imagenet_cov_estimation(varargin)
% CNN_IMAGENET_COV_ESTIMATION Estimate covariance on ImageNet training set
...
%                                                             Prepare model
% -------------------------------------------------------------------------
  net = load_model(opts.modelDir, opts.model, opts) ;
...
% -------------------------------------------------------------------------
function dag = load_model(modelDir, name, opts)
% -------------------------------------------------------------------------
  ...
  dag = insert_cov_estimator_layers(dag, opts) ;
